...
[incremental="true"]
* Aggregate를 정리하고 복합조회용 객체를 분리하면 Lazy loading이 꼭 필요할까 생각해볼수 있다.
...
* DTO류가 여러 레이어를 오간다면 Immutable하면 좋다.
